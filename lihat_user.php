...
if(isset($_GET['delete'])){
	$id = $_GET['id'];
	$statement->delete("tbl_user","kd_user",$id,"menus=lihat_user");
}
     ...
     foreach ($datas as $field): ?>	
      <?php if ($field['kd_user'] != "KSR0001"): ?>
		<tr>
			...
			<td>
					<a href="?menus=lihat_user&delete&id=<?= $field['kd_user'] ?>" class="btn btn-danger" onclick="return confirm('Apa anda yakin ?')">Delete <span class="fa fa-trash"></span></a>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" name="user" autocomplete="off" value="<?= $field['nama_user'] ?>" required>
        </div>
        </div>
        <div class="col-md-4">
        <div class="form-group">
          <label>Email</label>
          <input type="text" name="email" autocomplete="off" value="<?= $field['email'] ?>" placeholder="" class="form-control" required>
        </div>
        </div>
        <div class="col-md-4">
        <div class="form-group">
          <label for="">No Telp</label>
          <input type="text" class="form-control" name="no_telp" autocomplete="off" class="form-control" value="<?= $field['no_telp'] ?>" required >
        </div>
        </div>
        <div class="col-md-4">
        <div class="form-group">
          <label>Username</label>
          <input type="text" class="form-control" name="username" autocomplete="off" placeholder="" value="<?= $field['username'] ?>">
        </div>
        </div>
        <div class="col-md-4">
        	<div class="form-group">
